...
import { 
    ...
    CheckCircle2, Ruler, ShieldCheck, Sun, Eye 
} from "lucide-react";

const MirrorPolishedPage = () => {
    const router = useRouter();

    // Filter products that feature a polished finish
    const polishedProducts = useMemo(() => {
        return productsData.filter(p => 
            p.finish?.toLowerCase().includes('polish') || 
            p.title.toLowerCase().includes('polish') ||
            p.description.toLowerCase().includes('gloss') ||
            ...
            <section className="w-full bg-neutral-950 text-white py-24 lg:py-36 px-6 sm:px-10 lg:px-20 relative overflow-hidden">
                ...
                <div className="max-w-5xl mx-auto relative z-10 text-center">
                    <div className="inline-flex items-center gap-2 px-3 py-1 bg-neutral-900/80 border border-neutral-800 text-amber-400 text-[10px] font-mono uppercase tracking-[0.3em] mb-6 shadow-sm">
                        <Sparkles size={12} /> High-Gloss Optical Refraction
                    </div>
                    ...
                    <p className="text-base sm:text-lg text-neutral-300 font-sans leading-relaxed max-w-2xl mx-auto">
                        Achieved through a proprietary multi-stage diamond head grinding process, creating an ultra-reflective surface designed to amplify spatial light in grand interiors.
                    </p>
                </div>
            </section>
                ...
                <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-12 items-start">
                    <div>
                        <span className="text-[10px] font-mono uppercase tracking-[0.2em] text-neutral-400 block mb-2">
                            01 // Light Amplification
                        </span>
                        <h3 className="text-xl font-bold uppercase tracking-tight text-neutral-950 mb-3">
                            Maximum Reflection
                        </h3>
                        <p className="text-xs sm:text-sm text-neutral-600 leading-relaxed">
                            With a gloss rating exceeding 95%, polished porcelain acts as an optical mirror, bouncing natural light deep into architectural floor plans.
                        </p>
                    </div>

                    <div>
                        <span className="text-[10px] font-mono uppercase tracking-[0.2em] text-neutral-400 block mb-2">
                            02 // Micro-Porosity Zero
                        </span>
                        <h3 className="text-xl font-bold uppercase tracking-tight text-neutral-950 mb-3">
                            Diamond Calibration
                        </h3>
                        <p className="text-xs sm:text-sm text-neutral-600 leading-relaxed">
                            Microscopic pores are sealed during high-pressure sintering and diamond polishing, offering immaculate stain resistance and frictionless maintenance.
                        </p>
                    </div>

                    <div>
                        <span className="text-[10px] font-mono uppercase tracking-[0.2em] text-neutral-400 block mb-2">
                            03 // Grand Architecture
                        </span>
                        <h3 className="text-xl font-bold uppercase tracking-tight text-neutral-950 mb-3">
                            Seamless Continuity
                        </h3>
                        <p className="text-xs sm:text-sm text-neutral-600 leading-relaxed">
                            Engineered primarily for large-format slabs (up to 1600x3200mm), reducing grout lines to create uninterrupted expanses of liquid stone.
                        </p>
                    </div>
                </div>
            </section>
                ...
                <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 mb-12">
                    <div>
                        ...
                        <h2 className="text-3xl sm:text-4xl font-serif text-neutral-950">
                            Available Mirror Polished Surfaces
                        </h2>
                    </div>
                    <span className="text-xs font-mono text-neutral-500">
                        Showing {polishedProducts.length} Specifications
                    </span>
                </div>

                {polishedProducts.length === 0 ? (
                    <div className="text-center py-20 border border-dashed border-neutral-300 bg-white">
                        <p className="text-xs font-mono uppercase tracking-widest text-neutral-500 mb-4">No polished surfaces found in the current dataset.</p>
                ...
                <div className="max-w-5xl mx-auto flex flex-col md:flex-row items-center justify-between gap-8">
                    <div>
                        ...
                        <h2 className="text-2xl sm:text-3xl font-serif">
                            Need physical samples of our Mirror Polished range?
                        </h2>
                    </div>
                    <Link 
                        href="/contact?inquiry=Mirror+Polished+Sample+Box"
...
export default MirrorPolishedPage;